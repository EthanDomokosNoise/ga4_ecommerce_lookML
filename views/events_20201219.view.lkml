view: events_20201219 {
  sql_table_name: `ga4_ecommerce_sample.events_20201219`
    ;;
...
view: events_20201219__items {
  ...
  dimension: events_20201219__items {
    type: string
    hidden: yes
    sql: events_20201219__items ;;
  }
...
view: events_20201219__event_params {
  dimension: events_20201219__event_params {
    type: string
    hidden: yes
    sql: events_20201219__event_params ;;
  }
...
view: events_20201219__user_properties {
  dimension: events_20201219__user_properties {
    type: string
    hidden: yes
    sql: events_20201219__user_properties ;;
  }

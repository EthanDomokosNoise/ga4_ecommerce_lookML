view: events_20210110 {
  sql_table_name: `ga4_ecommerce_sample.events_20210110`
    ;;
...
view: events_20210110__items {
  ...
  dimension: events_20210110__items {
    type: string
    hidden: yes
    sql: events_20210110__items ;;
  }
...
view: events_20210110__event_params {
  dimension: events_20210110__event_params {
    type: string
    hidden: yes
    sql: events_20210110__event_params ;;
  }
...
view: events_20210110__user_properties {
  dimension: events_20210110__user_properties {
    type: string
    hidden: yes
    sql: events_20210110__user_properties ;;
  }

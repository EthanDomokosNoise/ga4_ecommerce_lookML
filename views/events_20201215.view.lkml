view: events_20201215 {
  sql_table_name: `ga4_ecommerce_sample.events_20201215`
    ;;
...
view: events_20201215__items {
  ...
  dimension: events_20201215__items {
    type: string
    hidden: yes
    sql: events_20201215__items ;;
  }
...
view: events_20201215__event_params {
  dimension: events_20201215__event_params {
    type: string
    hidden: yes
    sql: events_20201215__event_params ;;
  }
...
view: events_20201215__user_properties {
  dimension: events_20201215__user_properties {
    type: string
    hidden: yes
    sql: events_20201215__user_properties ;;
  }

view: events_20201106 {
  sql_table_name: `ga4_ecommerce_sample.events_20201106`
    ;;
...
view: events_20201106__items {
  ...
  dimension: events_20201106__items {
    type: string
    hidden: yes
    sql: events_20201106__items ;;
  }
...
view: events_20201106__event_params {
  dimension: events_20201106__event_params {
    type: string
    hidden: yes
    sql: events_20201106__event_params ;;
  }
...
view: events_20201106__user_properties {
  dimension: events_20201106__user_properties {
    type: string
    hidden: yes
    sql: events_20201106__user_properties ;;
  }

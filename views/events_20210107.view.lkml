view: events_20210107 {
  sql_table_name: `ga4_ecommerce_sample.events_20210107`
    ;;
...
view: events_20210107__items {
  ...
  dimension: events_20210107__items {
    type: string
    hidden: yes
    sql: events_20210107__items ;;
  }
...
view: events_20210107__event_params {
  dimension: events_20210107__event_params {
    type: string
    hidden: yes
    sql: events_20210107__event_params ;;
  }
...
view: events_20210107__user_properties {
  dimension: events_20210107__user_properties {
    type: string
    hidden: yes
    sql: events_20210107__user_properties ;;
  }

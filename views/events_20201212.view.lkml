view: events_20201212 {
  sql_table_name: `ga4_ecommerce_sample.events_20201212`
    ;;
...
view: events_20201212__items {
  ...
  dimension: events_20201212__items {
    type: string
    hidden: yes
    sql: events_20201212__items ;;
  }
...
view: events_20201212__event_params {
  dimension: events_20201212__event_params {
    type: string
    hidden: yes
    sql: events_20201212__event_params ;;
  }
...
view: events_20201212__user_properties {
  dimension: events_20201212__user_properties {
    type: string
    hidden: yes
    sql: events_20201212__user_properties ;;
  }

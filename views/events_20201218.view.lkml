view: events_20201218 {
  sql_table_name: `ga4_ecommerce_sample.events_20201218`
    ;;
...
view: events_20201218__items {
  ...
  dimension: events_20201218__items {
    type: string
    hidden: yes
    sql: events_20201218__items ;;
  }
...
view: events_20201218__event_params {
  dimension: events_20201218__event_params {
    type: string
    hidden: yes
    sql: events_20201218__event_params ;;
  }
...
view: events_20201218__user_properties {
  dimension: events_20201218__user_properties {
    type: string
    hidden: yes
    sql: events_20201218__user_properties ;;
  }

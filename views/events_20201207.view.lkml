view: events_20201207 {
  sql_table_name: `ga4_ecommerce_sample.events_20201207`
    ;;
...
view: events_20201207__items {
  ...
  dimension: events_20201207__items {
    type: string
    hidden: yes
    sql: events_20201207__items ;;
  }
...
view: events_20201207__event_params {
  dimension: events_20201207__event_params {
    type: string
    hidden: yes
    sql: events_20201207__event_params ;;
  }
...
view: events_20201207__user_properties {
  dimension: events_20201207__user_properties {
    type: string
    hidden: yes
    sql: events_20201207__user_properties ;;
  }

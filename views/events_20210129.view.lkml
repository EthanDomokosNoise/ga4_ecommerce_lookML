view: events_20210129 {
  sql_table_name: `ga4_ecommerce_sample.events_20210129`
    ;;
...
view: events_20210129__items {
  ...
  dimension: events_20210129__items {
    type: string
    hidden: yes
    sql: events_20210129__items ;;
  }
...
view: events_20210129__event_params {
  dimension: events_20210129__event_params {
    type: string
    hidden: yes
    sql: events_20210129__event_params ;;
  }
...
view: events_20210129__user_properties {
  dimension: events_20210129__user_properties {
    type: string
    hidden: yes
    sql: events_20210129__user_properties ;;
  }

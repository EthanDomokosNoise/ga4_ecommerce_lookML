view: events_20210122 {
  sql_table_name: `ga4_ecommerce_sample.events_20210122`
    ;;
...
view: events_20210122__items {
  ...
  dimension: events_20210122__items {
    type: string
    hidden: yes
    sql: events_20210122__items ;;
  }
...
view: events_20210122__event_params {
  dimension: events_20210122__event_params {
    type: string
    hidden: yes
    sql: events_20210122__event_params ;;
  }
...
view: events_20210122__user_properties {
  dimension: events_20210122__user_properties {
    type: string
    hidden: yes
    sql: events_20210122__user_properties ;;
  }

view: events_20201128 {
  sql_table_name: `ga4_ecommerce_sample.events_20201128`
    ;;
...
view: events_20201128__items {
  ...
  dimension: events_20201128__items {
    type: string
    hidden: yes
    sql: events_20201128__items ;;
  }
...
view: events_20201128__event_params {
  dimension: events_20201128__event_params {
    type: string
    hidden: yes
    sql: events_20201128__event_params ;;
  }
...
view: events_20201128__user_properties {
  dimension: events_20201128__user_properties {
    type: string
    hidden: yes
    sql: events_20201128__user_properties ;;
  }

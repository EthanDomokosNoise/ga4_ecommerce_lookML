view: events_20201226 {
  sql_table_name: `ga4_ecommerce_sample.events_20201226`
    ;;
...
view: events_20201226__items {
  ...
  dimension: events_20201226__items {
    type: string
    hidden: yes
    sql: events_20201226__items ;;
  }
...
view: events_20201226__event_params {
  dimension: events_20201226__event_params {
    type: string
    hidden: yes
    sql: events_20201226__event_params ;;
  }
...
view: events_20201226__user_properties {
  dimension: events_20201226__user_properties {
    type: string
    hidden: yes
    sql: events_20201226__user_properties ;;
  }

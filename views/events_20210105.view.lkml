view: events_20210105 {
  sql_table_name: `ga4_ecommerce_sample.events_20210105`
    ;;
...
view: events_20210105__items {
  ...
  dimension: events_20210105__items {
    type: string
    hidden: yes
    sql: events_20210105__items ;;
  }
...
view: events_20210105__event_params {
  dimension: events_20210105__event_params {
    type: string
    hidden: yes
    sql: events_20210105__event_params ;;
  }
...
view: events_20210105__user_properties {
  dimension: events_20210105__user_properties {
    type: string
    hidden: yes
    sql: events_20210105__user_properties ;;
  }

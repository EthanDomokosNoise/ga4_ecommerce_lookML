view: events_20201217 {
  sql_table_name: `ga4_ecommerce_sample.events_20201217`
    ;;
...
view: events_20201217__items {
  ...
  dimension: events_20201217__items {
    type: string
    hidden: yes
    sql: events_20201217__items ;;
  }
...
view: events_20201217__event_params {
  dimension: events_20201217__event_params {
    type: string
    hidden: yes
    sql: events_20201217__event_params ;;
  }
...
view: events_20201217__user_properties {
  dimension: events_20201217__user_properties {
    type: string
    hidden: yes
    sql: events_20201217__user_properties ;;
  }

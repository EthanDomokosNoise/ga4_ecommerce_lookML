view: events_20210106 {
  sql_table_name: `ga4_ecommerce_sample.events_20210106`
    ;;
...
view: events_20210106__items {
  ...
  dimension: events_20210106__items {
    type: string
    hidden: yes
    sql: events_20210106__items ;;
  }
...
view: events_20210106__event_params {
  dimension: events_20210106__event_params {
    type: string
    hidden: yes
    sql: events_20210106__event_params ;;
  }
...
view: events_20210106__user_properties {
  dimension: events_20210106__user_properties {
    type: string
    hidden: yes
    sql: events_20210106__user_properties ;;
  }

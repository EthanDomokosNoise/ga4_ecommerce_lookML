view: events_20201107 {
  sql_table_name: `ga4_ecommerce_sample.events_20201107`
    ;;
...
view: events_20201107__items {
  ...
  dimension: events_20201107__items {
    type: string
    hidden: yes
    sql: events_20201107__items ;;
  }
...
view: events_20201107__event_params {
  dimension: events_20201107__event_params {
    type: string
    hidden: yes
    sql: events_20201107__event_params ;;
  }
...
view: events_20201107__user_properties {
  dimension: events_20201107__user_properties {
    type: string
    hidden: yes
    sql: events_20201107__user_properties ;;
  }

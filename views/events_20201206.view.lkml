view: events_20201206 {
  sql_table_name: `ga4_ecommerce_sample.events_20201206`
    ;;
...
view: events_20201206__items {
  ...
  dimension: events_20201206__items {
    type: string
    hidden: yes
    sql: events_20201206__items ;;
  }
...
view: events_20201206__event_params {
  dimension: events_20201206__event_params {
    type: string
    hidden: yes
    sql: events_20201206__event_params ;;
  }
...
view: events_20201206__user_properties {
  dimension: events_20201206__user_properties {
    type: string
    hidden: yes
    sql: events_20201206__user_properties ;;
  }

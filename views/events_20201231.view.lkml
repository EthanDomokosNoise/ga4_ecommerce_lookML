view: events_20201231 {
  sql_table_name: `ga4_ecommerce_sample.events_20201231`
    ;;
...
view: events_20201231__items {
  ...
  dimension: events_20201231__items {
    type: string
    hidden: yes
    sql: events_20201231__items ;;
  }
...
view: events_20201231__event_params {
  dimension: events_20201231__event_params {
    type: string
    hidden: yes
    sql: events_20201231__event_params ;;
  }
...
view: events_20201231__user_properties {
  dimension: events_20201231__user_properties {
    type: string
    hidden: yes
    sql: events_20201231__user_properties ;;
  }
